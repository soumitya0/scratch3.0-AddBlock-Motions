...
class Scratch3DarshanBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroBit(this.runtime, Scratch3DarshanBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Scratch3DarshanBlocks.EXTENSION_ID,
            name: Scratch3DarshanBlocks.EXTENSION_NAME,
    ...
    _isTilted (direction) {
        ...
        case MicroBitTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= Scratch3DarshanBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= Scratch3DarshanBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Scratch3DarshanBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Scratch3DarshanBlocks;
