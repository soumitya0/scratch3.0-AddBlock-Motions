...
import ternImage from "./bisoftTern/tern.png";
    ...
    // },
    {
        ...
        name: (
            <FormattedMessage
                ...
                description="Name for the 'BISOFT TERN' extension"
                id="gui.extension.BisoftTERN.name"
            />
        ),
        extensionId: "BisoftTERN",

        description: (
            <FormattedMessage
                defaultMessage="Bisoft TERN Description"
                description="Description for the 'BISOFT TERN' extension"
                id="gui.extension.BisoftTERN.description"
            />
        ),
        featured: true,
    },
